  ...
  const downloadBadge = () => {
    ...
    import('html2canvas').then((html2canvas) => {
      html2canvas.default(badgeElement, {
        ...
        link.download = `Keploy_CICD_Integration_Badge.png`;
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 text-center">
          <div className="flex flex-wrap justify-center gap-2 text-sm">
            ...
            <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white font-medium">Session 4</span>
        ...
        <Card className="mt-6 bg-white/80 backdrop-blur-sm rounded-2xl container-shadow animate-slide-up-slow">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Session 4: CI/CD Integration</h3>
            <p className="text-gray-600 text-sm mb-4">
              Master the integration of API testing into continuous integration and deployment pipelines, 
              including automated testing, deployment strategies, and monitoring.
            </p>
