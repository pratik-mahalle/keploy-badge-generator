  ...
  const downloadBadge = () => {
    ...
    import('html2canvas').then((html2canvas) => {
      html2canvas.default(badgeElement, {
        ...
        link.download = `Keploy_Test_Replay_Analysis_Badge.png`;
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 text-center">
          <div className="flex flex-wrap justify-center gap-2 text-sm">
            ...
            <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white font-medium">Session 3</span>
            ...
            <Link href="/session-5" className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-white/80 hover:bg-white/20 transition-colors">Session 5</Link>
          ...
          <CardContent className="p-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 animate-fade-in-delay">
                Session 3: Test Replay & Analysis
              </p>
            </div>
        ...
        <Card className="mt-6 bg-white/80 backdrop-blur-sm rounded-2xl container-shadow animate-slide-up-slow">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Session 3: Test Replay & Analysis</h3>
            <p className="text-gray-600 text-sm mb-4">
              Learn advanced techniques for replaying API tests and analyzing results, including performance 
              metrics, error detection, and optimization strategies.
            </p>
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                Test Replay Techniques
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
