  ...
  const downloadBadge = () => {
    ...
    import('html2canvas').then((html2canvas) => {
      html2canvas.default(badgeElement, {
        ...
        link.download = `Keploy_Final_Project_Badge.png`;
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 text-center">
          <div className="flex flex-wrap justify-center gap-2 text-sm">
            ...
            <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white font-medium">Session 6</span>
          </div>
        </div>
        ...
        <Card className="mt-6 bg-white/80 backdrop-blur-sm rounded-2xl container-shadow animate-slide-up-slow">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Session 6: Final Project</h3>
            <p className="text-gray-600 text-sm mb-4">
              Capstone project demonstrating mastery of all API testing concepts. Complete end-to-end 
              testing implementation and comprehensive project assessment.
            </p>
